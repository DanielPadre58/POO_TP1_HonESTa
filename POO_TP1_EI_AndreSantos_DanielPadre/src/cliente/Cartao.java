...
public class Cartao {
    ...
    private long saldo;
    /* Todos os cupões que podem ser utilizados pelo cartão
    Cartoes são as keys
    Um boolean que armazena true caso estiver selecionado nos Values
    O
    */
    private HashMap<Cupao, Boolean> cupoes;
    //Estado de ativação do cartão
    ...
    //Desativa o cartão e todos os cupões que estavam selecionados
